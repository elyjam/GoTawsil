    ...
    <div class="row">
        <div class="col s12">
                                ...
                                <div class="responsive-table">
                                    <table id="list-datatable" class="table table-bordered table-striped">
                                     ...
                                     @endif
                                                ...
                                                <td> {{ @$record->EmployeDetail->name}} {{ @$record->EmployeDetail->first_name}}</td>
                                                <td> {{ $record->cloture_at }} </td>
                                                <td>
                                                    <a href="{{route('reclamation_detail', ['reclamation'=>$record->id])}}"><i
            ...
            <div style="bottom: 50px; right: 19px;" class="fixed-action-btn direction-top"><a
                    href="{{route('reclamation_create')}}"
                    class="btn-floating btn-large gradient-45deg-light-blue-cyan gradient-shadow pulse"><i
