                                ...
                                <table id="list-datatable" class="table table-bordered table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td> <a href="{{route('ancien_bon_pdf',$record->id)}}" target="_blank"><i
                                                class="material-icons tooltipped" style="color: #c10027;"
                                                data-position="top"
                                                data-tooltip="Imprimer bon N° {{ $record->code }} ">print</i></a>
                                    </td>
                                            <td>   <a
                                                href="{{ route('ancien_bon_exp', $record->id) }} "target="_blank"><i
                                                    class="material-icons tooltipped" style="color: #c10027;"
...
<script>
    ...
    document.getElementById("historique_bons").classList.add("activate");
