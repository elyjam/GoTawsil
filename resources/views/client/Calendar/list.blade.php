...
@section('content')
    ...
    <body>
        ...
        <div id="breadcrumbs-wrapper" data-image="/assets/images/gallery/breadcrumb-bg-client.jpg"
            class="breadcrumbs-bg-image" style="background-image: url(/assets/images/gallery/breadcrumb-bg.jpg&quot;);">
    ...
    <script>
        document.getElementById("calendrie").classList.add("activate");
        document.addEventListener('DOMContentLoaded', function() {
            var calendarEl = document.getElementById('calendar');
            var data = {!! $data !!}
            var calendar = new FullCalendar.Calendar(calendarEl, {
