...
<style>
    ...
    @media only screen and (min-width: 1100px) {
        ...
        .masse {
            margin: 1rem 15rem -1.4rem 15rem !important;
    ...
    <div class="row">
        ...
        <div class="col s12">
            <div class="container">
                ...
                <div class="section">
                    <!-- Modal Structure -->
                    <form method="POST" action="{{ route('expedition_update_client', $expedition->id) }}">
                        @csrf
                        <br>
                                ...
                                <div class="row">
                                    <div class="col s12 m12">
                                            ...
                                            <div class="containere">
                                                <div class="radio-tile-group">
                                                    <div class="input-container">
                                                        @if (old('type', $expedition->type) == 'ECOM')
                                                            <input checked class="radio-button tooltipped" type="radio"
                                                                name='type' value='ECOM' data-position="bottom"
                                                                data-tooltip="COLIS CONTRE REMBOURSEMENT" id='ECOM'
                                                                onchange="changetype(this)" checked>
                                                        @else
                                                            <input class="radio-button tooltipped" type="radio"
                                                                name='type' value='ECOM' data-position="bottom"
                                                                data-tooltip="COLIS CONTRE REMBOURSEMENT" id='ECOM'
                                                                onchange="changetype(this)" checked>
                                                        @endif
                                                    ...
                                                    @if (auth()->user()->clientDetail->colisSimple == 'Oui' || auth()->user()->clientDetail->factureMois == 'Oui')
                                                        <div class="input-container">
                                                            @if (old('type', $expedition->type) == 'CDP')
                                                                <input checked class="radio-button tooltipped"
                                                                    type="radio" name='type' value='CDP'
                                                                    data-position="bottom" data-tooltip="COLIS DÉJÀ PAYER"
                                                                    id='CDP' onchange="changetype(this)">
                                                            @else
                                                                <input class="radio-button tooltipped" type="radio"
                                                                    name='type' value='CDP' data-position="bottom"
                                                                    data-tooltip="COLIS DÉJÀ PAYER" id='CDP'
                                                            ...
                                                            <div class="radio-tile">
                                                                ...
                                                                <label for="CDP" class="radio-tile-label">Colis déjà
                                                                    payer
                                                                </label>
                                                            </div>
                                                        </div>
                                                    ...
                                                    @if ($mes_expedition->count() != null && auth()->user()->clientDetail->colisEchange == 'Oui')
                                                        <div class="input-container">
                                                            @if (old('type', $expedition->type) == 'COLECH')
                                                                <input checked class="radio-button tooltipped"
                                                                    type="radio" name='type' value='COLECH'
                                                                    data-position="bottom" data-tooltip="Colis en échange"
                                                                    id='COLECH' onchange="changetype(this)">
                                                            @else
                                                                <input class="radio-button tooltipped" type="radio"
                                                                    name='type' value='COLECH' data-position="bottom"
                                                                    data-tooltip="Colis en échange" id='COLECH'
                                                                    onchange="changetype(this)">
                                                            @endif
                                                            ...
                                                            <div class="radio-tile">
                                                                <div class="icon walk-icon">
                                                                    <svg version="1.0" xmlns="http://www.w3.org/2000/svg"
                                                                        ...
                                                                        <g transform="translate(0.000000,512.000000) scale(0.100000,-0.100000)"
                                                                            stroke="none">
                                                                            <path
                                                                                d="M2395 4993 c-285 -33 -494 -88 -735 -190 -326 -139 -653 -380 -876
                                                                            ...
                                                                            <path
                                                                                d="M2560 4383 c-8 -3 -348 -181 -755 -395 -556 -293 -749 -399 -776
                                                                                ...
                                                                                10 -853z" />
                                                                            <path
                                                                                d="M455 4227 c-14 -21 -12 -39 14 -200 32 -191 45 -227 101 -264 42 -29
                                                                            ...
                                                                            <path
                                                                                d="M566 1368 c-9 -12 -16 -28 -16 -34 0 -14 109 -181 134 -206 20 -21
                                                                                69 -24 84 -5 28 35 23 53 -45 153 -36 54 -71 102 -77 106 -23 16 -65 8 -80
                                                                                -14z" />
                                                                            <path
                                                                                d="M804 1045 c-23 -36 -11 -60 79 -152 86 -89 117 -102 150 -65 33 36
                                                                ...
                                                                <label for="COLECH" class="radio-tile-label">Colis en
                                                                    échange
                                                                </label>
                                                            </div>
                                                        </div>
                                        ...
                                        @if (\Auth::user()->ClientDetail->num_exp != 'AUTO')
                                            <div class="row">
                                                <div class="col col m12 s12 px-5 input-field" id="num_exp">
                                                    <div class="col col m12 s12 input-field">
                                                        <input name="num_exp" value="{{ old('num_exp',$expedition->num_expedition) }}"
                                                            autocomplete="off" readonly
                                                            onfocus="this.removeAttribute('readonly');" type="text">
                                                        <label for="num_exp"> Numéro d'expedition </label>
                                                        @error('num_exp')
                                                            <span
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col col m6 s12 px-5 input-field">
                                                <select name='agence_des' id='agence_des'
                                                    ...
                                                    @foreach ($agenceRecords as $row)
                                                        <option class='option'
                                                            {{ $row->id == old('agence_des', $expedition->agence_des) ? 'selected' : '' }}
                                            ...
                                            <div class="col col m6 s12 input-field">
                                                <input id="destinataire" name="destinataire"
                                                    value="{{ old('destinataire', $expedition->destinataire) }}"
                                                    autocomplete="off" readonly
                                                    onfocus="this.removeAttribute('readonly');" type="text">
                                        ...
                                        <div class="row">
                                            <div class="col m6 s12 input-field">
                                                <input id="adresse_destinataire" name="adresse_destinataire"
                                                    value="{{ old('adresse_destinataire', $expedition->adresse_destinataire) }}"
                                                    autocomplete="off" readonly
                                                    onfocus="this.removeAttribute('readonly');" type="text">
                                            ...
                                            <div class="col m6 s12 input-field">
                                                <input id="telephone" name="telephone"
                                                    value="{{ old('telephone', $expedition->telephone) }}"
                                                    autocomplete="off" readonly
                                                    onfocus="this.removeAttribute('readonly');" type="text">
                                        ...
                                        <div class="row">
                                            <div class="col col m6 s12 input-field">
                                                <input id="colis" name="colis"
                                                    value="{{ old('colis', $expedition->colis) }}" autocomplete="off"
                                                    readonly onfocus="this.removeAttribute('readonly');" type="number"
                                                    max="10" min="1">
                                            ...
                                            <div id="montant" class="col m6 s12 input-field">
                                                <input id="fond" name="fond"
                                                    value="{{ old('fond', $expedition->fond) }}" autocomplete="off"
                                            ...
                                            <div id="document" class="col m6 s12 input-field">
                                                <input id="bl" name="bl" value="{{ old('bl') }}"
                                                    autocomplete="off" readonly
                                                    onfocus="this.removeAttribute('readonly');" type="text">
                                        ...
                                        <div class="row">
                                            <div class="col col m6 s12 input-field">
                                                <input id="Indication" name="Indication"
                                                    value="{{ old('Indication', $expedition->Indication) }}"
                                                    autocomplete="off" readonly
                                                    onfocus="this.removeAttribute('readonly');" type="text">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col col m6 s12 input-field">
                                                <input id="vDeclaree" name="vDeclaree" value="{{ old('vDeclaree',$expedition->vDeclaree) }}"
                                                    autocomplete="off" readonly
                                                    onfocus="this.removeAttribute('readonly');" type="text">
                                            ...
                                            <div class="col col m6 s12">
                                                ...
                                                <br>
                                                <label>
                                                    <input checked type="checkbox" class="filled-in"
                                                        name='ouvertureColis' id='ouvertureColis' />
...
@section('js')
    ...
    <script>
        document.getElementById("saisie").classList.add("activate");
                ...
                if (cid != '') {
                    $.ajax({
                        ...
                        success: function(result) {
                            ...
                            $('#fond').val(result['fond']).next().addClass("active");
                            $('#agence_des option[value="' + result['destination'] + '"]').prop(
                                'selected', true)
        ...
        function changetype(element) {
            if (element.id == 'ECOM' && element.checked) {
                ...
                document.getElementById('document').style.display = 'none';
                document.getElementById('Expeditions').style.display = 'none';
                document.getElementById('num_exp').style.display = 'block';
            ...
            } else if (element.id == 'COLECH' && element.checked) {
                document.getElementById('document').style.display = 'none';
                document.getElementById('montant').style.display = 'block';
                document.getElementById('Expeditions').style.display = 'block';
                document.getElementById('num_exp').style.display = 'none';
            }
        }

        if (document.getElementById('CDP').checked) {
        ...
        } else if (document.getElementById('ECOM').checked) {
        ...
        } else if (document.getElementById('COLECH').checked) {
