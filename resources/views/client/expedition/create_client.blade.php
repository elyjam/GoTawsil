    ...
    <div class="row">
        ...
        <div class="col s12">
            <div class="container">
                ...
                <div class="section">
                    <a class="waves-effect waves-light btn modal-trigger masse"  href="{{route('expedition_import')}}"><i class="material-icons left">file_upload</i>Chargement en masse</a>
                    <!-- Modal Structure -->
                                ...
                                <div class="row">
                                    <div class="col s12 m12">
                                            ...
                                            <div class="containere">
                                                <div class="radio-tile-group">
                                                    <div class="input-container">
                                                        @if ( old('type') == "ECOM")
                                                        <input checked  class="radio-button tooltipped" type="radio" name='type'
                                                    ...
                                                    <div class="input-container">
                                                        @if ( old('type') == "CDP")
                                                        <input  checked class="radio-button tooltipped" type="radio" name='type'
                                                        value='CDP' data-position="bottom"
                                                    ...
                                                    <div class="input-container">
                                                        @if ( old('type') == "COLECH")
                                                        <input  checked class="radio-button tooltipped" type="radio" name='type'
                                                            value='COLECH' data-position="bottom"
                                                        ...
                                                        <div class="radio-tile">
                                                            ...
                                                            <label for="COLECH" class="radio-tile-label">Colis en échange
                                                            </label>
                                                        </div>
                                                    </div>
                                                    @endif
                                        ...
                                        <div class="row">
                                            <div class="col col m12 s12 px-5 input-field" id="num_exp">
                                                <div class="col col m12 s12 input-field">
                                                    <input  name="num_exp"
                                                        value="{{ old('num_exp') }}" autocomplete="off" readonly
                                        ...
                                        <div class="row">
                                            ...
                                            @if ( old('type') != "COLECH")
                                            <div class="col col m6 s12 px-5 input-field" id="Destination">
                                            ...
                                            @endif
                                            @if ( old('type') != "CDP")
                                            <div class="col col m6 s12 px-5 input-field" id="agence_des_echange">
                                                <input id="agence_echange"  autocomplete="off"
...
@section('js')
    ...
    <script>
                ...
                if (cid != '') {
                    $.ajax({
                        ...
                        success: function(result) {
                            ...
                            $('#agence_echange').val(result['destination']).next().addClass("active");
                            $('#agence_des option[value="'+result['destination']+'"]').prop('selected', true)
        ...
        document.getElementById('agence_des_echange').style.display = 'none';
        ...
        function changetype(element) {
            if (element.id == 'ECOM' && element.checked) {
                ...
                document.getElementById('agence_des_echange').style.display = 'block';
