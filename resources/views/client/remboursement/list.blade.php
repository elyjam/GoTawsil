                                ...
                                <table id="list-datatable" class="table table-bordered table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a target="_blank"
                                                    href="{{route('remboursement_print_detail', ['remboursement'=>$record->rembDetail->id, 'paiement'=>$record->id])}}">
...
@section('js')
<script>
    document.getElementById("remboursement").classList.add("activate");
