    ...
    <div class="col s12">
        <div class="container">
            <div class="section">
                ...
                <form method="POST" action="{{route('bonliv_update', ['bonliv' => $record->id])}}">
                    @csrf
                    <br>
                        ...
                        <div class="row">
                                <div class="col s12 m12">
                                    <div class="row">
                                        ...
                                        <div class="col s6 input-field">
                                            <input id="created" name="created" value="{{old('created', $record->created)}}" autocomplete="off"
                                            readonly onfocus="this.removeAttribute('readonly');" type="text">
                                    ...
                                    <option value=''></option>
                                        @foreach ($employeRecords as $row)
                                            <option class='option' {{($row->id == old('livreur', $record->livreur)) ? 'selected' : ''}}
                                    ...
                                    @enderror
                                        ...
                                        <div class="col s6 input-field">
                                            <input id="closed_at" name="closed_at" value="{{old('closed_at', $record->closed_at)}}" autocomplete="off"
                                            readonly onfocus="this.removeAttribute('readonly');" type="text">
