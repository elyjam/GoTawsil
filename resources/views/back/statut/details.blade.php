    ...
    <div class="col s12">
        <div class="container">
            <div class="section">
                ...
                <form method="POST" action="{{route('statut_update', ['statut' => $record->id])}}">
                    @csrf
                    <br>
                        ...
                        <div class="row">
                                <div class="col s12 m12">
                                    <div class="row">
                                        ...
                                        <div class="col s6 input-field">
                                            <input id="key" name="key" value="{{old('key', $record->key)}}" autocomplete="off"
                                            readonly onfocus="this.removeAttribute('readonly');" type="text">
                                            <label for="key"> Identifiant </label>
                                            @error('key')
                                                <span class="helper-text materialize-red-text">{{ $message }}</span>
                                            @enderror
                                        </div>                
                                        <div class="col s6 input-field">
                                            <input id="value" name="value" value="{{old('value', $record->value)}}" autocomplete="off"
                                            readonly onfocus="this.removeAttribute('readonly');" type="text">
                            ...
                            <div class="row">
                                <div class="col s12 m12">
                                    <div class="col s12 display-flex justify-content-end mt-3">
                                        <a href="{{route('statut_list')}}"><button type="button"
