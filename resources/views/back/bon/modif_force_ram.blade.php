        ...
        <div class="col s12">
            <div class="container">
                <div class="section">
                    ...
                    @endif
                    <br>
                    <form action="{{ route('insert_force', $records->id) }}" method="post">
                        @csrf
                                ...
                                <div class="row">
                                    <div class="col s12">
                                        <table id="multi-select" class="display">
                                            ...
                                            <tbody>
                                                @foreach ($records->expeditionBonNull as $record)
                                                    <tr>
                                                        <td> <label>
                                                                <input value="{{ $record->id }}" type="checkbox"
                                                                    name="selectField[]" />
                                                                <span>
                                                                    @if ($record->etape == '1')
                                                                        <i class="blue-text material-icons"
