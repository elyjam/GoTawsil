    ...
    <div class="container">
        <div class="row">
            <div class="col s12 m6 l6">
                <h5 class="breadcrumbs-title mt-0 mb-0"><span>Gestion des bons</span></h5>
            </div>
...
<div class="row">
    <div class="col s12">
        <div class="container">
            <div class="section">
                <form method="POST" action="{{route('bon_create')}}">
                    @csrf
                    <br>
                    <div class="card">
                            ...
                            <div class="row">
                                <div class="col s12 m12">
                                    <div class="row">
                                        ...
                                        <div class="col s6 input-field">
                                            <input id="date_cloture" name="date_cloture" value="{{old('date_cloture')}}" autocomplete="off"
                                            readonly onfocus="this.removeAttribute('readonly');" type="text">
                                        ...
                                        <div class="col s6 input-field">
                                            <input id="date_validation" name="date_validation" value="{{old('date_validation')}}" autocomplete="off"
                                            readonly onfocus="this.removeAttribute('readonly');" type="text">
                                        ...
                                        <div class="col s6 input-field">
                                            <input id="id_organisme" name="id_organisme" value="{{old('id_organisme')}}" autocomplete="off"
                                            readonly onfocus="this.removeAttribute('readonly');" type="text">
                                        ...
                                        <div class="col s6 input-field">
                                            <input id="type" name="type" value="{{old('type')}}" autocomplete="off"
                                            readonly onfocus="this.removeAttribute('readonly');" type="text">
                                        ...
                                        <div class="col s6 input-field">
                                            <input id="id_transporteur" name="id_transporteur" value="{{old('id_transporteur')}}" autocomplete="off"
                                            readonly onfocus="this.removeAttribute('readonly');" type="text">
                                        ...
                                        <div class="col s6 input-field">
                                            <input id="id_agence_dest" name="id_agence_dest" value="{{old('id_agence_dest')}}" autocomplete="off"
                                            readonly onfocus="this.removeAttribute('readonly');" type="text">
                                        ...
                                        <div class="col s6 input-field">
                                            <input id="id_agence_exp" name="id_agence_exp" value="{{old('id_agence_exp')}}" autocomplete="off"
                                            readonly onfocus="this.removeAttribute('readonly');" type="text">
                                        ...
                                        <div class="col s6 input-field">
                                            <input id="transaction_user" name="transaction_user" value="{{old('transaction_user')}}" autocomplete="off"
                                            readonly onfocus="this.removeAttribute('readonly');" type="text">
                                        ...
                                        <div class="col s6 input-field">
                                            <input id="id_employe" name="id_employe" value="{{old('id_employe')}}" autocomplete="off"
                                            readonly onfocus="this.removeAttribute('readonly');" type="text">
