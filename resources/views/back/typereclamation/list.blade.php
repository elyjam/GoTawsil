    ...
    <div class="container">
        <div class="row">
            <div class="col s12 m6 l6">
                <h5 class="breadcrumbs-title mt-0 mb-0"><span>Gestion des typereclamations</span></h5>
            </div>
            <div class="col s12 m6 l6 right-align-md">
                <ol class="breadcrumbs mb-0">
                    <li class="breadcrumb-item"><a href="{{route('admin')}}">Accueil</a>
                    </li>
                    <li class="breadcrumb-item"><a href="{{route('typereclamation_list')}}">Liste des typereclamations</a>
                    </li>
                </ol>
            </div>
        </div>
...
<div class="row">
    <div class="col s12">
                                ...
                                <table id="list-datatable" class="table table-bordered table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="hide-on-small-only"> {{ $record->code }} </td>
                                            <td> {{ $record->libelle }}

                                                <p class="hide-on-med-and-up">
                                                    <span class="new badge gradient-45deg-light-blue-cyan" data-badge-caption="Type : {{ $record->roleDetail->label }}"></span>
                                                </p>
                                            </td>
                                            <td class="hide-on-small-only"> {{ $record->statut }} </td>
                                            <td class="hide-on-small-only"> {{ $record->roleDetail->label }} </td>
                                            <td>
                                                <a href="{{route('typereclamation_update', ['typereclamation'=>$record->id])}}"><i
        ...
        <div style="bottom: 50px; right: 19px;" class="fixed-action-btn direction-top"><a href="{{route('typereclamation_create')}}" class="btn-floating btn-large gradient-45deg-light-blue-cyan gradient-shadow"><i class="material-icons">add</i></a></div>
    </div>
</div>
...
<script>
    ...
    function suppRecord() {
        window.location.replace("/typereclamation/delete/"+$("#delId").val());
    }
