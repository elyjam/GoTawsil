    ...
    <div class="col s12">
        <div class="container">
            <div class="section">
                ...
                <form method="POST" action="{{route('banque_update', ['banque' => $record->id])}}">
                    @csrf
                    <br>
                    ...
                    <div class="card">
                        ...
                        <div class="row">
                                <div class="col s12 m12">
                                    ...
                                    <option value=''></option>
                                <option value="1" {{($record->statut == '1') ? 'selected' : ''}}> actif </option> 
<option value="2" {{($record->statut == '2') ? 'selected' : ''}}> inactif </option> 
                            ...
                            <div class="row">
                                <div class="col s12 m12">
                                    <div class="col s12 display-flex justify-content-end mt-3">
                                        <a href="{{route('banque_list')}}"><button type="button"
