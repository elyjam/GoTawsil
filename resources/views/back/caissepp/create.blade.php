    ...
    <div class="container">
        <div class="row">
            <div class="col s12 m6 l6">
                <h5 class="breadcrumbs-title mt-0 mb-0"><span>Gestion des caissepps</span></h5>
            </div>
            <div class="col s12 m6 l6 right-align-md">
                <ol class="breadcrumbs mb-0">
                    <li class="breadcrumb-item"><a href="{{route('admin')}}">Accueil</a>
                    </li>
                    <li class="breadcrumb-item"><a href="{{route('caissepp_list')}}">Liste des caissepps</a>
                    </li>
                </ol>
            </div>
        </div>
...
<div class="row">
    <div class="col s12">
        <div class="container">
            <div class="section">
                <form method="POST" action="{{route('caissepp_create')}}">
                    @csrf
                    <br>
                    <div class="card">
                                ...
                                <div class="col s12 m12">
                                    <div class="row">
                                        ...
                                        <div class="col s6 input-field">
                                            <input id="reception_date" name="reception_date" value="{{old('reception_date')}}" autocomplete="off"
                                        ...
                                        <div class="col s6 input-field">
                                            <input id="emp" name="emp" value="{{old('emp')}}" autocomplete="off"
                                            readonly onfocus="this.removeAttribute('readonly');" type="text">
                                        ...
                                        <div class="col s6 input-field">
                                            <input id="montant" name="montant" value="{{old('montant')}}" autocomplete="off"
                                            readonly onfocus="this.removeAttribute('readonly');" type="text">
                                        ...
                                        <div class="col s6 input-field">
                                            <input id="action" name="action" value="{{old('action')}}" autocomplete="off"
                                            readonly onfocus="this.removeAttribute('readonly');" type="text">
