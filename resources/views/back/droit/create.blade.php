...
<div class="row">
    <div class="col s12">
        <div class="container">
            <div class="section">
                <form method="POST" action="{{route('droit_create')}}">
                    @csrf
                    <br>
                    <div class="card">
                            ...
                            <div class="row">
                                <div class="col s12 m12">
                                    <div class="row">
                                        ...
                                        <div class="col s6 input-field">
                                            <input id="description" name="description" value="{{old('description')}}" autocomplete="off"
                                            readonly onfocus="this.removeAttribute('readonly');" type="text">
                            ...
                            <div class="row">
                                <div class="col s12 m12">
                                    <div class="col s12 display-flex justify-content-end mt-3">
                                        <a href="{{route('droit_list')}}"><button type="button"
