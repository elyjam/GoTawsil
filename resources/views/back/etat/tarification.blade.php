        ...
        <div class="container">
            <div class="row">
                <div class="col s12 m6 l6">
                    <h5 class="breadcrumbs-title mt-0 mb-0"><span> Tarification
                        </span></h5>
                </div>
            </div>
        </div>
        ...
        <div class="col s12">
            <div class="container">
                <div class="section">
                    ...
                    @endif
                    <br>
                    <form target="_blank" action="{{ route('tarification') }}" method="post">
                        @csrf
                                ...
                                <div class="card-content">
                                    <div class="row">
                                        <div class="col s12 m6 input-field">
                                            <select name='depart' id='depart' class="select2 browser-default">
                                        ...
                                        <div class="col s12 m6 input-field">
                                            <select name='Destination' id='Destination' class="select2 browser-default">
                                                <option value='0'>TOUTES DESTINATION</option>
