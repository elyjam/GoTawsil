        ...
        <div class="container">
            <div class="row">
                <div class="col s12 m6 l6">
                    <h5 class="breadcrumbs-title mt-0 mb-0"><span>Gestion des regions</span></h5>
                </div>
                <div class="col s12 m6 l6 right-align-md">
                    <ol class="breadcrumbs mb-0">
                        <li class="breadcrumb-item"><a href="{{ route('admin') }}">Accueil</a>
                        </li>
                        <li class="breadcrumb-item"><a href="{{ route('region_list') }}">Liste des regions</a>
                        </li>
                    </ol>
                </div>
            </div>
                                        ...
                                        <tbody>
                                            @foreach ($records as $record)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="{{ route('region_update', ['region' => $record->id]) }}"><i
...
@section('js')
    <script>
        ...
        function suppRecord() {
            window.location.replace("/region/delete/" + $("#delId").val());
        }
