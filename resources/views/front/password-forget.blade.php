                            ...
                            <div class="row shadow" >
                                <div class="col-md-offset-6 col-md-6 col-sm-offset-6 col-sm-6">
                                    <div class="form-container">
                                        ...
                                        <h3 class="title px-5">Récupération de mot de passe</h3>
                                        <form class="form-horizontal" method="POST" action="{{ route('forget_password') }}">
                                            @csrf
                                            <div class="input-field">
                                                ...
                                                <label for="icon_prefix">Votre adresse Email</label>
                                            </div>
                                            @error('email')
