                            ...
                            <div class="row shadow" >
                                <div class="col-md-offset-6 col-md-6 col-sm-offset-6 col-sm-6">
                                    <div class="form-container">
                                        ...
                                        <h3 class="title px-5">Réinitialiser Votre mot de passe</h3>
                                        <form class="form-horizontal" method="POST" action="{{ route('get_password',$token) }}">
                                            @csrf
                                            <div class="input-field">
                                                <i class="material-icons prefix">account_circle</i>
                                                <input id="icon_prefix" type="password" class="validate"
                                                    placeholder="Votre nouveau mot de passe" name="password" value=""
                                                    autocomplete="off" readonly
                                                    onfocus="this.removeAttribute('readonly');">
                                                <label for="icon_prefix">Votre nouveau mot de passe</label>
                                            </div>
                                            @error('password')
                                            ...
                                            <div class="input-field">
                                                <i class="material-icons prefix">account_circle</i>
                                                <input id="icon_prefix" type="password" class="validate"
                                                    placeholder="Confirmation mot de passe" name="password_confirmation" value=""
                                                    autocomplete="off" readonly
                                                    onfocus="this.removeAttribute('readonly');">
                                                <label for="icon_prefix">Confirmation mot de passe</label>
                                            </div>
                                            ...
                                            @enderror
                                            <button class="btn signin">GO</button>
                                        </form>
