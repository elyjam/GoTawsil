        ...
        <div class="col s12">
            <div class="container">
                <div class="row">
                            ...
                            <div class="row shadow" >
                                <div class="col-md-offset-6 col-md-6 col-sm-offset-6 col-sm-6">
                                    <div class="form-container">
                                        ...
                                        <h3 class="title px-5">Espace clients</h3>
                                        <form class="form-horizontal" method="POST" action="{{ route('login') }}">
                                            @csrf
                                            <div class="input-field">
                                                <i class="material-icons prefix">account_circle</i>
                                                <input id="icon_prefix" type="text" class="validate"
                                                    placeholder="Identifiant" name="login" value="{{ old('login') }}"
                                            ...
                                            <span class="forgot-pass"><a href="{{route('forget_password')}}">Mot de passe
                                                    oublié ?</a></span>
                    ...
                    {{--                                    <h5 class="ml-4">المرجو تسجيل الدخول</h5>--}}
                    {{--                                </div>--}}
                    {{--                            </div>-->--}}
                    ...
                    {{--                                    <input placeholder="Identifiant" name="login" value="{{ old('login') }}"--}}
                    ...
                    {{--                                <div class="input-field col s12">--}}
                    {{--                                    <button type="submit"--}}
                    {{--                                        class="btn waves-effect waves-light border-round gradient-45deg-purple-deep-orange col s12"> Connexion--}}
                    {{--                                        </button>--}}
                    {{--                                </div>--}}
                    {{--                            </div>--}}
                    {{--                            <!--<div class="row">--}}
