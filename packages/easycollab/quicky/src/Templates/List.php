...
<div class="row">
    <div class="col s12">
                                ...
                                <table id="list-datatable" class="table table-bordered table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            {td}
                                            <td>
                                                <a href="{{route('{projetId}_update', ['{projetId}'=>$record->id])}}"><i
        ...
        <div style="bottom: 50px; right: 19px;" class="fixed-action-btn direction-top"><a href="{{route('{projetId}_create')}}" class="btn-floating btn-large gradient-45deg-light-blue-cyan gradient-shadow"><i class="material-icons">add</i></a></div>
    </div>
</div>
...
<script>
    ...
    function suppRecord() {
        window.location.replace("/{projetId}/delete/"+$("#delId").val());
    }
