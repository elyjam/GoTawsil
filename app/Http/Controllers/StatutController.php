    ...
    public function create(Request $request){
        ...
        if ($request->isMethod('post')) {
            ...
            if ($validator->fails()) {
                ...
                Redirect::to(route('statut_list'))->send();
            }
        }
        $viewsData = [];


        return view('back/statut/create', $viewsData);
    }

    public function update(Statut $statut, Request $request){
        ...
        return view('back/statut/details' , $viewsData);
    }
