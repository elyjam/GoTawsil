...
class RemboursementAncien extends Model
{
    protected $table = 'remboursements_ancien';
    ...
    public static function generate($clients, $type, $date){
        ...
        $expeditions = Remboursement::getExpeditionsByClients($clients, $date);
    ...
    {
        return $this->belongsToMany(Expedition::class, 'remboursements_expeditions_ancien', 'remboursement_id', 'expedition_id');
    }
...
//dd($clients);
        ...
        foreach($clients as $client){
            ...
            $body = '
                <table style="width:100% !important;  height:100% !important; " cellpadding="2">
                        ...
                        <tr>
                            ...
                            <td width="5%" style="height:18px !important;  font-size: 7px !important; border:0,2px solid !important;" bgcolor="#e2e2e2" >
                            <b>Colis</b>
                            </td>
                            <td width="5%" style="height:18px !important;  font-size: 8px !important; border:0,2px solid !important;" bgcolor="#e2e2e2" >
                            <b>Port</b>
                            </td>
                            <td width="9%" style="height:18px !important;  font-size: 8px !important; border:0,2px solid !important;" bgcolor="#e2e2e2" >
                            <b>Fond</b>
                ...
                foreach ($expeditions as $expedition) {
                    if ($expedition->client_id == $client['client_id']) {
                        ...
                        <tr>
                            ...
                            <td style="height:18px !important; font-size: 8px !important;text-align:left !important;border:0,2px solid !important;" >'.date('Y/m/d', strtotime($expedition->created_at)).'
                            </td>
            ...
            $total = '<br><br><table style="width:100% !important;  height:100% !important; " cellpadding="2">
                        <tr>
                            <td  width="17%" style="height:18px !important; font-size: 8px !important;text-align:left !important;border:0,2px solid !important;" bgcolor="#e2e2e2">
                            ...
                            <td  width="16%" style="height:18px !important; font-size: 8px !important;text-align:left !important;border:0,2px solid !important;" bgcolor="#e2e2e2">
                                <b>TOTAL FRAIS</b>
                            </td>
                            <td  width="16%" style="height:18px !important; font-size: 8px !important;text-align:left !important;border:0,2px solid !important;" bgcolor="#e2e2e2">
                                <b>TOTAL NET</b>
    ...
    public function ordreVirement($clients, $remboursement, $expeditions, $cheques){
        ...
        $html = '
            ...
            foreach ($clients as $client) {
                ...
                $html .= '
                <tr>
                    <td width="40%" style="height:18px !important; font-size: 8px !important;text-align:left !important;border:0,2px solid !important;" >
                    '.$client['name'].'
                    </td>
                    <td width="40%" style="height:18px !important; font-size: 8px !important;text-align:left !important;border:0,2px solid !important;" >
                        '.$client['rib'].'
                    ...
                    <td width="20%" style="height:18px !important;text-align: right !important;  font-size: 8px !important; border:0,2px solid !important;" >
                        '.Util::moneyFormat($netsTotal).'
                    </td>
                </tr>
            ';
        ...
        $html .= '
                <tr>
                    <td width="40%" style="height:18px !important; font-size: 8px !important;text-align:left !important;" >
                    </td>
