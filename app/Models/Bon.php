...
class Bon extends Model
{
    ...
    public function count_exps(){
        $exps = etapeHistory::where('id_chargement', $this->id)->pluck('expedition')->toarray();

        $expeditions = Expedition::whereIN('id',$exps)->where('etape','!=','5')->count();
        return $expeditions;
    }
    ...
    public static function printDetail($caisse)
    {
        ...
        // Add a page
        $pdf::AddPage();
        $record = Expedition::all()->where('id_bon', $caisse->id);
        ...
        foreach ($record as $exp) {
            ...
            $exp_table = $exp_table . '<tr>
                    ...
                    <td style="height:18px !important;text-align: right !important;  font-size: 7px !important; border:0,2px solid !important;" >' . $frais . '</td>
                </tr>';
        }
...
' . $exp_table . '
    ...
    public static function printDetailClient($expeditions)
    {
        $pdf = new \PDF(PDF_PAGE_ORIENTATION, PDF_UNIT, PDF_PAGE_FORMAT, true, 'UTF-8', false);

        $pdf::setHeaderCallback(function ($pdf) use ($expeditions){
            $header = '
                <table style="width:100% !important;  height:100% !important; " cellpadding="5">
                    <tr >
                        <td style="height:25px !important; font-size: 10px !important;text-align:left !important;" width="20%">
                ...
                <table style="width:100% !important;  height:100% !important; " cellpadding="5">
                    <tr >
                        ...
                        <td style="height:25px !important; font-size: 10px !important;text-align:left !important;" width="40%">
                        '.$expeditions->first()->clientDetail->libelle.'
                        </td>
...
' . $exp_table . '
            ...
            <br><br><table style="width:100% !important;  height:100% !important; " cellpadding="2">
                <tr>
                    <td width="25%" style="height:18px !important; font-size: 9px !important;text-align:center !important;border:0,2px solid !important;"  bgcolor="#e2e2e2"><b>TOTAL EXPEDITIONS</b>
                    </td>
                    <td width="25%" style="height:18px !important; font-size: 9px !important;text-align:center !important;border:0,2px solid !important;" bgcolor="#e2e2e2"><b>TOTAL COLIS</b>
                    </td>
                    <td width="25%" style="height:18px !important;  font-size: 9px !important;text-align:center !important;border:0,2px solid !important;" bgcolor="#e2e2e2" ><b>TOTAL FOND</b>
                    </td>
                    <td width="25%" style="height:18px !important;  font-size: 9px !important;text-align:center !important;border:0,2px solid !important;" bgcolor="#e2e2e2" ><b>TOTAL PP</b>
                    </td>

                </tr>
                <tr>
                    <td width="25%" style="height:18px !important; font-size: 9px !important;text-align:center !important;border:0,2px solid !important;" ><b>' . $expeditions->count() . '</b>
                    </td>
                    <td width="25%" style="height:18px !important; font-size: 9px !important;text-align:center !important;border:0,2px solid !important;" ><b>' . $total_colis . '</b>
                    </td>
                    <td width="25%" style="height:18px !important;  font-size: 9px !important;text-align:center !important;border:0,2px solid !important;"  ><b>' . number_format($total_fond, 2) . ' Dhs</b>
                    </td>
                    <td width="25%" style="height:18px !important;  font-size: 9px !important;text-align:center !important;border:0,2px solid !important;"  ><b>' . number_format($total_frais, 2) . ' Dhs</b>
                    </td>
